...
header #branding h1{
  margin:0;
	...
	<td colspan="8" align="right"><a href="logoutadmin.php"><font color="cream"><b>Logout</b></font></a></td>
	</tr>
	</table>
 ...
 <li><a href="home_for_admin.php"><font color="pink">Home</font></a></li>
 <li><a href="employee.php"><font color="pink">Add Employee </font></a></li>
 <li><a href="listofemployee.php"><font color="pink">Employee List</font></a></li>
 <li><a href="productsforadmin.php"><font color="pink">Products List</font></a></li>
 ...
 <div align="center">
  ...
  <h1>Welcome Admin, <?php echo $aname; ?></h1><br> <br>
