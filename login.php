<?php
	...
	$sqlUserCheck = "SELECT name, password FROM registration WHERE name = '$uName'";
	...
	if($rowCount < 1){
		...
		while($row = mysqli_fetch_assoc($result)){
			...
			if( password_verify($password, $PassInDb) ){
				...
				$_SESSION['id'] = $id;
				$_SESSION['name']=$uName;
				header("Location: displayforclient.php");
			}
			else{
...
<style>
		...
		<h1 class="header">Log in</h1><br><br>
		<div class="vl">
		...
		<div class="text">
			...
			<a href="registration.php">NewComers?Register Now!!!</a><br><br>
		</form>
	</div>
