<?php
	...
	$id=$upass=$message=$message1=$check=$uName="";
	...
	$sqlUserCheck = "SELECT name, password FROM employee WHERE name = '$uName'";
	...
	if($rowCount < 1){
		...
		while($row = mysqli_fetch_assoc($result)){
			...
			if( $password== $PassInDb ){
				...
				header("Location: home_for_employee.php");
...
<style>
		...
		<h1 class="header">Employees Log in</h1><br><br>
		<div class="vl">
